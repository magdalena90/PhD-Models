---
title: 'Top Modules Exploratory Analysis'
output:
  html_document:
    code_folding: 'hide'
---
...
Since these modules have the strongest relation to autism, this pattern should be reflect in their model eigengenes, having two different behaviours for the samples corresponding to autism and the ones corresponding to control

```{r}

module = top_modules[1]
