...
932/980 SFARI genes are present in the dataset (~95%), 
```{r}
...
**From now on, we're only going to focus on the 910 genes with a score**
...
- At a threshold of log2(1.1), we lose all genes belonging to score 1 and 2

- If we stick to the original null hypothesis $H_0: lfc=0$, 263/910 SFARI genes are statistically significant (29%)
