...
- The heavy right tale from the sample distribution corresponds to a group of Autism samples. In general, the autism group has a bigger mean and are more spread out than the control group
...
Higher perplexities seem to capture the difference between diagnosis better, although at the end they seem to be capturing another pattern as well, since the samples seem to be grouped in pairs
```{r tsne_genes, warning=FALSE, message=FALSE, fig.width=10, fig.height=10}
