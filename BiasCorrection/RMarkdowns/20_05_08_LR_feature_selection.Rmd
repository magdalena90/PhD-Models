---
title: 'Logistic Regression with Feature Selection'
output:
  html_document:
    code_folding: 'hide'
---
...
```{r probability_and_meanExpr, warning=FALSE, message=FALSE, fig.width=10}
...
```{r probability_and_SD, warning=FALSE, message=FALSE, fig.width=10}
